  ...
  return (
    <div>
      ...
      >
        ...
        <CardHeader
          title={props.user}
          subheader={new Date(props.startTime * 1000).toLocaleDateString()}
        />
        ...
        <CardContent>
          <Typography variant="body2" color="text.secondary">
            ...
            <br />
            Return Time: {Math.ceil(parseInt(props.timeToReturn) / (60 * 60 * 24))} Days
            <br />
            Bank Amount: {props.bankAmount}
          </Typography>
          <br />

          <CardActions>
            <Button size="small" onClick={handleChangeStatusClick}>
              Change Status
            </Button>
        ...
        <Dialog open={openWithdrawDialog} onClose={handleCloseWithdrawDialog}>
          ...
          <DialogActions>
            ...
            <Button onClick={handleConfirmWithdrawDialog}>Confirm</Button>
          </DialogActions>
        </Dialog>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>Please enter the new status:</DialogContentText>
          <TextField
            autoFocus
            margin="dense"
            label="New Status"
        ...
        <DialogActions>
          ...
          <Button onClick={handleConfirmChangeStatusDialog}>Confirm</Button>
        </DialogActions>
      </Dialog>
        ...
        <Dialog open={openDepositDialog} onClose={handleCloseDepositDialog}>
          ...
          <DialogActions>
            ...
            <Button onClick={handleConfirmDepositDialog}>Confirm</Button>
          </DialogActions>
        </Dialog>
      </Card>
    </div>
